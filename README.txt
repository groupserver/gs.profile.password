...
The code for this module was originally written for the ``Products.CustomUserFolder`` module. 
...
``CustomUserFolder``
    The code for getting a user from a password-reset ID was taken from
    the ``CustomUserFolder`` class and turned into some factories.
